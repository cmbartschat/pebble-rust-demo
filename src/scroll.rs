            ...
            c.single(
                Button::Select,
                {
                    ...
                    move |_| {
                        ...
                        scroll.with_content_indicator(|indicator| {
                            indicator.set_content_available(ContentIndicatorDirection::Up, hidden);
                            indicator
                                .set_content_available(ContentIndicatorDirection::Down, !hidden);
                        });
                    }
                },
                None,
